...
//	~Maze();
	...
	//use DFS and precomuted distances to store in the DFSarray for when monsters return home
	
	void computeDistance(int sx, int sy);
	...
	int getNumMazeValue(int x, int y);
...
private:
	...
	int DFSarray[21][23]; //will be used for depth for search to store chars
